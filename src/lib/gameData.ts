...
export const SQUAD_RESULTS: Record<NationName, SquadResult> = {
  'Canada':    { wins: 0, draws: 1, losses: 0, groupWin: false, advance: false },
  'Spagna':    { wins: 0, draws: 0, losses: 0, groupWin: false, advance: false },
  'Giappone':  { wins: 0, draws: 1, losses: 0, groupWin: false, advance: false },
  'Marocco':   { wins: 0, draws: 1, losses: 0, groupWin: false, advance: false },
  'Messico':   { wins: 1, draws: 0, losses: 0, groupWin: false, advance: false },
  'Germania':  { wins: 1, draws: 0, losses: 0, groupWin: false, advance: false },
  'Svizzera':  { wins: 0, draws: 1, losses: 0, groupWin: false, advance: false },
  'Brasile':   { wins: 0, draws: 1, losses: 0, groupWin: false, advance: false },
  'USA':       { wins: 1, draws: 0, losses: 0, groupWin: false, advance: false },
